import { StacksClient, BCS } from "stacks";
...
export class ContractService {
  ...
  constructor() {
    this.client = new StacksClient(CONTRACT_CONFIG.NODE_URL);
  }
  ...
  async getAccountBalance(address: string): Promise<string> {
    try {
      ...
      const coinResource = resources.find(r => r.type === "0x1::coin::CoinStore<0x1::stacks_coin::StacksCoin>");
