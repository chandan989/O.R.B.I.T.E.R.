  ...
  return (
    <>
      <div className="antialiased">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-10">
                    <Link
                      to="/launch-sequence"
                      className="cta-button inline-block bg-gradient-to-r from-[#FE6440] to-[#FFC700] text-black font-bold font-space-grotesk px-8 py-4 rounded-lg text-lg text-center"
                    >
                      [ INITIATE LAUNCH SEQUENCE ]
                    </Link>
                    <a
                      href="https://github.com/chandan989/O.R.B.I.T.E.R/blob/main/PITCH_DECK.md"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-[#FE6440] rounded-lg font-bold font-space-grotesk text-lg hover:bg-[#FE6440]/10 transition-all duration-300"
                    >
            ...
            <div className="relative">
              ...
              <div className="relative p-8 rounded-lg glass-panel">
                ...
                <p className="font-ibm-plex-sans text-gray-300 leading-relaxed">
                  ...
                  Stacks Objects on the Stacks blockchain.
                </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <div className="pt-1 text-[#FFC700]">&#10142;</div>
                  <p>
                    <strong className="font-semibold">Clarity language security</strong> with formal
          ...
          <div className="text-center">
            ...
            <div className="relative mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
              ...
              <div className="relative glass-panel p-6 rounded-lg text-left z-10 flex flex-col">
                ...
                <p className="text-gray-300 flex-grow">
                  Customize your asset’s on-chain parameters, including the symbol for its liquid shares, before creating the Stacks Object.
                </p>
              </div>
              ...
              <div className="relative glass-panel p-6 rounded-lg text-left z-10 flex flex-col">
                ...
                <p className="text-gray-300 flex-grow">
                  Your asset achieves stable orbit as a tradable token on Stacks, visible in your Constellation and the Exosphere.
                </p>
              </div>
        ...
        <section id="blog-highlight" className="py-20 fade-in-section">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/5 p-4 rounded-lg border border-border">
                    ...
                    <ul className="text-sm text-gray-300 space-y-1">
                      ...
                      <li>• Penny transactions ($0.001 gas)</li>
                  ...
                  <div className="bg-black/5 p-4 rounded-lg border border-border">
                    ...
                    <ul className="text-sm text-gray-300 space-y-1">
                      ...
                      <li>• DeFi collateral integration</li>
                    </ul>
                  </div>
                </div>
              </div>
