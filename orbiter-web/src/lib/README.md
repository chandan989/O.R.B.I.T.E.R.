...
This library provides TypeScript utilities for integrating with ORBITER smart contracts on Stacks. It includes type definitions, contract interaction helpers, event handling, transaction building, and React hooks.
...
// Format utilities
const formatted = utils.formatAPT(1000000000); // "10.00 USDCx"
...
createDomainObject(account: StacksAccount, payload: CreateDomainPayload): Promise<string>

// Transfer domain ownership
transferDomain(account: StacksAccount, domainObject: string, newOwner: string): Promise<string>
...
initializeFractionalOwnership(account: StacksAccount, domainObject: string, totalSupply: number, ticker: string): Promise<string>

// Transfer shares
transferShares(account: StacksAccount, payload: TransferSharesPayload): Promise<string>
...
```typescript
// Create listing
createListing(account: StacksAccount, payload: CreateListingPayload): Promise<string>

// Buy shares
buyShares(account: StacksAccount, payload: BuySharesPayload): Promise<string>

// Cancel listing
cancelListing(account: StacksAccount, listingObject: string): Promise<string>
...
VITE_NODE_URL=https://fullnode.testnet.stackslabs.com/v1
VITE_FAUCET_URL=https://faucet.testnet.stackslabs.com
```
...
const config: ContractConfig = {
  ...
  faucet_url: 'https://faucet.testnet.stackslabs.com'
};
...
// Format USDCx amounts
utils.formatAPT(1000000000); // "10.00 USDCx"
utils.formatAPT(1500000000); // "15.00 USDCx"
...
- Consult the Stacks documentation: https://stacks.dev