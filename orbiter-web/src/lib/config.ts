...
export const NETWORK_CONFIGS = {
  testnet: {
    ...
    explorer_url: 'https://explorer.stackslabs.com/?network=testnet',
    chain_id: 2
  },
  mainnet: {
    name: 'Mainnet',
    node_url: 'https://fullnode.mainnet.stackslabs.com/v1',
    explorer_url: 'https://explorer.stackslabs.com/?network=mainnet',
    chain_id: 1
  },
  devnet: {
    name: 'Devnet',
    node_url: 'https://fullnode.devnet.stackslabs.com/v1',
    faucet_url: 'https://faucet.devnet.stackslabs.com',
    explorer_url: 'https://explorer.stackslabs.com/?network=devnet',
    chain_id: 3
  }
} as const;
