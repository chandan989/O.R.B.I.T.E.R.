    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test your deployed smart contracts on Stacks Testnet
          </CardDescription>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <a 
              href={`https://explorer.stackslabs.com/account/${CONTRACT_CONFIG.CONTRACT_ADDRESS}/modules?network=testnet`}
              target="_blank"
