    ...
    <div className="space-y-6">
      <Card className="bg-gray-900/50 border-gray-700">
        <CardHeader>
          ...
          <CardDescription>
            REAL blockchain transactions via backend API - actual Clarity contract calls on Stacks Testnet
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="bg-gray-800/50 p-4 rounded-lg">
            ...
            >
              View on Stacks Explorer <ExternalLink className="h-3 w-3" />
            </a>
          </div>
          ...
          <div className="bg-blue-900/20 border border-blue-700/50 p-4 rounded-lg">
            ...
            <ol className="text-sm text-gray-300 space-y-1 list-decimal list-inside">
              <li>Registry creates global domain storage on Stacks</li>
              <li>Domain gets tokenized as an Stacks Object with valuation data</li>
