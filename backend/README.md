...
This backend submits REAL transactions to Stacks blockchain using your private key.
...
- Submits REAL transactions to Stacks testnet
...
You'll see REAL transaction hashes that you can verify on Stacks Explorer!
